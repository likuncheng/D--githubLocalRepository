...
public interface CompanyListMapper {
	...
	public List<T_Com_Info> findCompanysByIndustry_categroy(@Param("industry_categroyclass")Industry_categroyclass industry_categroyclass);
	//根据企业规模来查询出所有符合条件的公司
	...
	public List<T_Com_Info> findCompanysByAllCondition(@Param("allConditionForCompanys")AllConditionForCompanys allConditionForCompanys);
}
